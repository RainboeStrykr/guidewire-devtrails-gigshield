...
import { ChevronLeft, Shield, MapPin, Calendar, Clock, DollarSign, CloudRain } from 'lucide-react';
        ...
        <div className="gs-body" style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '30px' }}>
            ...
            <div className="gs-card" style={{ padding: '24px', borderLeft: '4px solid #3B6D11' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  <div className="gs-mono" style={{ fontSize: '20px', fontWeight: 500 }}>₹{policy?.premium || '29'}</div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                <div>
                  ...
                  <div className="gs-mono" style={{ fontSize: '22px', color: 'var(--color-text-primary)' }}>₹{policy?.maxCoverage || '4,500'}</div>
                </div>
                <div>
          ...
          <div>
            ...
            <div className="gs-card">
              ...
              <div className="gs-trigger-row" style={{ padding: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ background: '#FAEEDA', padding: '10px', borderRadius: '8px' }}>🌫</div>
                  <div>
              ...
              <div className="gs-trigger-row" style={{ padding: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ background: '#FAECE7', padding: '10px', borderRadius: '8px' }}>🔥</div>
                  <div>
