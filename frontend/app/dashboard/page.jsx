        ...
        <div className="gs-root">
            ...
            <div className="gs-hero">
                <div>
                    ...
                    <div className="gs-rider-meta">
                        <span className="gs-platform-badge" onClick={() => router.push('/onboarding')} style={{ cursor: 'pointer' }}>{rider?.platform || 'Blinkit'}</span>
                ...
                <div className="gs-policy-card" onClick={() => router.push('/policy')} style={{ cursor: 'pointer' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px' }}>
                        ...
                        <span className="gs-mono" style={{ fontWeight: 500, color: 'var(--color-text-primary)' }}>Rs.{policy?.premium || 61}</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', marginTop: '4px' }}>
                        <span style={{ color: 'var(--color-text-secondary)' }}>Max payout</span>
                        <span className="gs-mono" style={{ fontWeight: 500, color: 'var(--color-text-primary)' }}>Rs.{policy?.maxCoverage || 900} / week</span>
                    </div>
                </div>
            </div>
            ...
            <div className="gs-metrics">
                <div className="gs-metric">
                    ...
                    <div className="gs-metric-val">Rs.3,840</div>
                    <div className="gs-metric-unit">out of Rs.4,200 target</div>
                    <div className="gs-metric-delta gs-delta-down">Rs.360 disruption loss</div>
                </div>
                <div className="gs-metric">
                    <div className="gs-metric-label">Payout received</div>
                    <div className="gs-metric-val">Rs.210</div>
                    <div className="gs-metric-unit">3 hrs x Rs.70/hr</div>
            ...
            <div className="gs-body">
                ...
                <div>
                    ...
                    {/* Rain alert - active */}
                    <div className="gs-alert-card" onClick={() => router.push('/trigger')} style={{ cursor: 'pointer' }}>
                        <div className="gs-alert-header">
                            <div className="gs-alert-icon rain" style={{ fontSize: '18px' }}>R</div>
                            <div>
                        ...
                        <div className="gs-alert-body">
                            ...
                            <div className="gs-alert-stat">
                                ...
                                <div className="gs-alert-stat-val" style={{ color: '#3B6D11' }}>Rs.140</div>
                            </div>
                        </div>
                    ...
                    <div className="gs-alert-card">
                        <div className="gs-alert-header">
                            <div className="gs-alert-icon aqi" style={{ fontSize: '18px' }}>A</div>
                            <div>
                    ...
                    <div className="gs-card">
                        <div className="gs-claim-row">
                            <div className="gs-claim-icon" style={{ background: '#E6F1FB', fontSize: '14px' }}>R</div>
                            ...
                            <div style={{ textAlign: 'right' }}>
                                <div className="gs-claim-amount" style={{ color: '#3B6D11' }}>+Rs.210</div>
                                <div className="gs-claim-badge gs-badge-paid">Paid</div>
                            </div>
                        </div>
                        <div className="gs-claim-row">
                            <div className="gs-claim-icon" style={{ background: '#FAEEDA', fontSize: '14px' }}>A</div>
                            <div className="gs-claim-info">
                                <div className="gs-claim-type">AQI Severe - 6h</div>
                                <div className="gs-claim-date">Sat 29 Mar - Chennai</div>
                            </div>
                            <div style={{ textAlign: 'right' }}>
                                <div className="gs-claim-amount" style={{ color: '#3B6D11' }}>+Rs.420</div>
                                <div className="gs-claim-badge gs-badge-paid">Paid</div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className="gs-tier-row">
                        <div className={`gs-tier-card ${selectedTier === 'basic' ? 'selected' : ''}`} onClick={() => setSelectedTier('basic')}>
                            ...
                            <div className="gs-tier-price">Rs.29</div>
                            <div className="gs-tier-week">/week</div>
                            <div className="gs-tier-payout">Max Rs.500</div>
                        ...
                        <div className={`gs-tier-card ${selectedTier === 'standard' ? 'selected' : ''}`} onClick={() => setSelectedTier('standard')}>
                            ...
                            <div className="gs-tier-price">Rs.61</div>
                            <div className="gs-tier-week">/week (zone adj.)</div>
                            <div className="gs-tier-payout">Max Rs.900</div>
                        ...
                        <div className={`gs-tier-card ${selectedTier === 'pro' ? 'selected' : ''}`} onClick={() => setSelectedTier('pro')}>
                            ...
                            <div className="gs-tier-price">Rs.79</div>
                            <div className="gs-tier-week">/week</div>
                            <div className="gs-tier-payout">Max Rs.1,500</div>
                    ...
                    <button
                        ...
                        disabled={isRenewing}
                    >
                        {isRenewing ? 'Confirming via UPI...' : `Renew Option - Rs.${selectedTier === 'basic' ? 29 : selectedTier === 'standard' ? 61 : 79} via UPI auto-debit`}
                    </button>
                    <button className="gs-action-btn" onClick={() => router.push('/policy')}>View full policy document</button>
