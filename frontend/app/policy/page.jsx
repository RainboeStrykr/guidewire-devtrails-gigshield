                ...
                <div className="gs-body" style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '24px' }}>
                    <div>
                            ...
                            <div style={{ display: 'grid', gap: '20px' }}>
                                ...
                                <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: '13px', color: 'var(--color-text-secondary)', lineHeight: 1.4 }}>Rs.70 for every 30 minutes of intensity above threshold.</div>
                                    </div>
                                </div>
                        ...
                        <div className="gs-card">
                            ...
                            <div className="gs-claim-row" style={{ cursor: 'pointer' }} onClick={() => router.push('/faq')}>
                        ...
                        <div className="gs-card" style={{ padding: '20px' }}>
                            ...
                            <div style={{ display: 'grid', gap: '12px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                    ...
                                    <span className="gs-mono" style={{ fontSize: '13px', fontWeight: 500 }}>Rs.{policy?.premium || '29'}</span>
                                </div>
                                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                    <span style={{ fontSize: '12px', color: 'var(--color-text-tertiary)' }}>Max Coverage</span>
                                    <span className="gs-mono" style={{ fontSize: '13px', fontWeight: 500 }}>Rs.{policy?.maxCoverage || '4,500'}</span>
                                </div>
                                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
